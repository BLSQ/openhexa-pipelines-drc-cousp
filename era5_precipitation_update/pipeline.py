...
@pipeline(code="era5-precipitation-update", name="ERA5_precipitation_update")
@parameter(
    "manual_run",
    name="Manual run",
...
def era5_precipitation_update(manual_run:bool):
    """
    In this pipeline we call a notebook launcher that executes the COUSP tables update
...
@era5_precipitation_update.task
