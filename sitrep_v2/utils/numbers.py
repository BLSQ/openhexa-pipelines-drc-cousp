...
def fmt_int(value: object) -> str:
    """Formate un entier à la française (séparateur de milliers = espace).

    Returns:
        str: La valeur formatée (« 5 669 »), ou la chaîne telle quelle si ce
        n'est pas un int (ex. ``config.ND``).
    """
