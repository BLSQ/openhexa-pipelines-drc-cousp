...
from openhexa.sdk import current_run, pipeline, parameter, workspace, File
...
def mpox_table_update(mpox_file: File, mpox_update: bool):
    ...
    # Run file checks
    exec = run_update_with(
        nb_name=nb_checker_name,
        nb_path=nb_checker_path,
        out_nb_path=nb_checker_output,
    ...
    if mpox_update:
        ...
        # Run database update
        run_update_with(
            nb_name=nb_uploader_name,
            nb_path=nb_uploader_path,
            out_nb_path=nb_uploader_output,
            parameters=parameters,
            exec=exec,
        )
